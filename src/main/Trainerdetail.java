...
import javax.swing.JOptionPane;
      ...
      public class Trainerdetail extends javax.swing.JFrame {
    ...
    public Trainerdetail(String Firstname, String Lastname, String PhoneNo, String Age,  String Gender,
            String Dayofbirth, String Monthofbirth, String Yearofbirth, String Trainertype, String Height,
            String Weight) {
        initComponents();
        ...
        displayTrainerDetail();
       
    }

    private void displayTrainerDetail() {
        ...
        jTextField6.setText(Dayofbirth);
        jTextField7.setText(Monthofbirth);
        jTextField8.setText(Yearofbirth);
        jComboBox1.setSelectedItem(Trainertype);
        jTextField10.setText(Height);
   ...
   try{
    ...
    String updatedPhoneNo = jTextField3.getText();
    String updatedAge = jTextField4.getText();
    String updatedGender = jTextField5.getText();
    String updatedDayofbirth = jTextField6.getText();
    String updatedMonthofbirth = jTextField7.getText();
    String updatedYearofbirth = jTextField8.getText();
    String updatedTrainertype = jComboBox1.getSelectedItem().toString();
    String updatedHeight = jTextField10.getText();
    String updatedWeight = jTextField11.getText();
       ...
       Connection connection = DriverManager.getConnection(url, username, password);
        ...
        String sql = "UPDATE Trainerdetails SET Firstname=?, Lastname=?, PhoneNo=?, Age=?, Gender=?, Dayofbirth=?, Monthofbirth=?, Yearofbirth=?, Trainertype=?, Height=?, Weight=? WHERE Firstname=? AND Lastname=?";
          PreparedStatement statement = connection.prepareStatement(sql);
        statement.setString(1, updatedFirstname);
        statement.setString(2, updatedLastname);
        statement.setString(3, updatedPhoneNo);
        statement.setString(4, updatedAge);
        statement.setString(5, updatedGender);
        statement.setString(6, updatedDayofbirth);
        statement.setString(7, updatedMonthofbirth);
        statement.setString(8, updatedYearofbirth);
        statement.setString(9, updatedTrainertype);
        statement.setString(10, updatedHeight);
        statement.setString(11, updatedWeight);
        statement.setString(12, Firstname); 
        statement.setString(13, Lastname); 
        int rowsUpdated = statement.executeUpdate();
JOptionPane.showMessageDialog(null, Firstname + "'s information successfully entered into the database");
      
 Customizetrainer welcomeFrame =new Customizetrainer();
...
private void deleteTrainerDetails() {
    try {
        ...
        String sql = "DELETE FROM Trainerdetails WHERE Firstname=? AND Lastname=?";
        PreparedStatement statement = connection.prepareStatement(sql);
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Personal Trainer", "Body Builder Trainer", "Group Exercise Instructor", "Senior Fitness Instructor", "Medical Fitness Trainer", "Yoga Instructor" }));
        ...
        jLabel27.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/ed.png"))); // NOI18N
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addComponent(jLabel27, javax.swing.GroupLayout.PREFERRED_SIZE, 501, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void jLabel23MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel23MouseClicked
        Customizetrainer page=new Customizetrainer();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int confirmed = JOptionPane.showConfirmDialog(null, "Are you sure you want to delete this trainer?", "Confirm Deletion", JOptionPane.YES_NO_OPTION);
    if (confirmed == JOptionPane.YES_OPTION) {
         deleteTrainerDetails();
    }
        Customizetrainer customizetrainer = new Customizetrainer();
        customizetrainer.setVisible(true);
           customizetrainer.pack();
          customizetrainer.setLocationRelativeTo(null);
        this.dispose(); 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Trainerdetail.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
               new Trainerdetail().setVisible(true);
            }
        });
    }
